      ...
      <div class="row m-1">
        <div class="col col-12 col-sm-12 col-md-6 col-lg-6 col-xl-7">
          ...
          <ul class="list-unstyled"> 
            <li><i class="fas fa-check red"></i> Formación para el título de trasnportista de mercancía pesada.</li>
            <li><i class="fas fa-check red"></i> Formación para el título de trasnportista de viajeros.</li>
            <li><i class="fas fa-check red"></i> Formación para el título de trasnportista de mercancía pesada y transportista de viajeros.</li>
          </ul>
        </div>
    ...
    <div class="accordion reveal reveal-scale" id="accordion">
      ...
      <div class="accordion-item">
        ...
        <div id="text5accordion" class="accordion-collapse collapse" data-bs-parent="#accordion">
          <div class="accordion-body text-justify">
            Se cobrar una matrícula 100€ y se realizara una cuota mensual de 100€ a lo largo del año. La cantidad anual fija es de 1.100€. Para mayor información sobre el costo de la matricula hablanos al el correo info@certitransporte.com o llegar a Avda. San Francisco Javier, 24 - Edif. HERMES 41018 - Sevilla.</p>
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="text6accordion" class="accordion-collapse collapse" data-bs-parent="#accordion">
          <div class="accordion-body">
            <p class="text-justify">El horario de las dichas clases es principalmente online, tambien habra clases presenciales o videoconferencias para resolver dudas y supuestos.</p>
            <p>Las horas de dichas clases son:</p>
            <ul>
              <li>40 presenciales</li>
              <li>120 tele presenciales (online)</li>
            </ul>
          </div>
        </div>
      </div>
